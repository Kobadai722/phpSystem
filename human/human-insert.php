    ...
    <div class="container py-4">
        ...
        <form action="human-insert.php" method="post" class="needs-validation" novalidate>
            <div class="row g-3">
                ...
                <div><div class="col-md-6"><label for="PASSWORD" class="form-label">パスワード <span class="text-danger">*</span></label><input type="password" class="form-control" id="PASSWORD" name="PASSWORD" required></div></div>
            </div>
            <hr class="my-4">
